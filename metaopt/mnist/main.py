...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="mnist", choices=["mnist", "fmnist"], help="The name of dataset")
    ...
    for epoch in range(args.num_epoch + 1):
        ...
        for batch_idx, (data, target) in enumerate(dataset[TRAIN]):
            ...
            model, loss, accuracy, output, noise, grad_vec = feval(
                data, target, model, optimizer, is_cuda=is_cuda, mode="meta-train", opt_type=opt_type
            )
